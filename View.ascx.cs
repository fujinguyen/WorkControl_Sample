/*
' Copyright (c) 2016  workcontrol.com
'  All rights reserved.
' 
...
using WorkControl.Modules.Sample.Components;
...
namespace WorkControl.Modules.Sample
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from SampleModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : SampleModuleBase, IActionable
    {
